...
namespace TesodevMicroservices.OrderService.Application.Validator.UpdateOrder
{
    public class UpdateOrderDtoValidator : AbstractValidator<UpdateOrderDto>
    {
        ...
        {
            RuleFor(x => x.Id).NotEmpty().WithMessage("Id Field Can not be Null or Empty.");
            ...
            //Child Validators
            RuleFor(x => x.Address).NotNull().WithMessage("Address Object Can not be Null.").SetValidator(new UpdateAddressDtoValidator());
            RuleFor(x => x.Product).NotNull().WithMessage("Product Object Can not be Null.").SetValidator(new UpdateProductDtoValidator());
